...
<head>
  ...
  <link rel="stylesheet" href="styleCetakBukti.css">
</head>
<body>
  <div class="receipt-container">
    <div class="receipt">
      ...
      <div class="totals">
        ...
        <p><strong>CASH</strong> <span>IDR <?= number_format($total, 0, ',', '.') ?></span></p>
      </div>
      <?php else: ?>
      ...
      <button class="back-button" id="backButton" onclick="window.location.href='menuKasir.php'">BACK TO MENU</button>
    </div>
  </div>
</body>
</html>